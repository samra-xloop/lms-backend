...
urlpatterns = [
    ...
    path('assignment_partners_group/<int:assignment_partners_group_id>/assignment_partners/', Assignment_PartnersByAssignment_Partners_GroupListView.as_view(), name='assignment_partners-assignment_partners_group-list'),
