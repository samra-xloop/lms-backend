# Generated by Django 4.2.3 on 2023-09-21 10:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_delete', models.BooleanField(default=False)),
                ('deleted_at', models.DateTimeField(auto_now=True)),
                ('parent', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='course.category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_updated_by', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Module',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submitted_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assignment_submission_done_by', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('assignment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='course.assignment')),
                ('submitted_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assignment_submitted_by', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('assignment_group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='course.assignment_partners_group')),
                ('partners', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='partner', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assignment_submission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='course.assignment_submission')),
                ('grader', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assignment_grader', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assignment_doer', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
